...
#define LIBEXPLAIN_HAVE_BLUETOOTH_BLUETOOTH_H 1

/* Define to 1 if you have the <bluetooth/bnep.h> header file. */
#define LIBEXPLAIN_HAVE_BLUETOOTH_BNEP_H 1
...
/* Define to 1 if you have the declaration of `ustat', and to 0 if you don't.
   */
#define LIBEXPLAIN_HAVE_DECL_USTAT 0
...
#define LIBEXPLAIN_HAVE_LIBV4L1_VIDEODEV_H 1
...
#define LIBEXPLAIN_HAVE_LINUX_IF_H 1
...
#define LIBEXPLAIN_HAVE_LINUX_IF_PPP_H 1
...
/* #undef LIBEXPLAIN_HAVE_LINUX_NCP_FS_H */
...
#define LIBEXPLAIN_HAVE_LOCALE_GEN_PROG 1
...
/* #undef LIBEXPLAIN_HAVE_SYS_USTAT_H */
...
/* #undef LIBEXPLAIN_HAVE_USTAT */

/* Define to 1 if you have the <ustat.h> header file. */
/* #undef LIBEXPLAIN_HAVE_USTAT_H */
...
/* #undef LIBEXPLAIN_HAVE__G_CONFIG_H */
...
#define LIBEXPLAIN_NET_IF_LINUX_IF_PLAY_NICE 1
...
#define LIBEXPLAIN__PATH_MOUNTED "/etc/mtab"
